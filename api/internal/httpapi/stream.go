...
func writeSSE(w http.ResponseWriter, ev Event) error {
	...
	// The rule below guards against unescaped HTML. This is an event stream,
	// not a document: the response is text/event-stream, the payload is the
	// output of json.Marshal, and the event name is a constant chosen in this
	// package. html/template would corrupt the JSON rather than protect it.
